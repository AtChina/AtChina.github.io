...
DISQUS.define(function(a, b) {
		...
		var s = "//referrer.disqus.com/juggler",
			t = a.document,
			u = function() {
				var a, b, c = function() {
					return !1
		...
		var k = j.extend({
			...
			state: null,
			getUrl: function(a, b) {
				return e.ensureHttpBasedProtocol(e.get(this.name, a, b), h)
			},
			getFrame: function() {
		...
		var l = k.extend({
				...
				getScrollContainer: function() {
					...
					return a === f.body && (a = g), this.scrollContainer = a
				},
				...
				events: {
					...
					"frame:mainViewRendered": function(a, b) {
						this.rendered = !0, this.wasInViewport = !1, b.trigger("resize", a), b.sendMessage("embed.rendered"), this.trigger("loading.done")
					},
		...
		var b = DISQUS.next.host,
			...
			f = d.extend({
				...
				events: {
					...
					"frame:openReady": function() {
						this.frame.show(), this.frame.sendMessage("open");
					...
					"frame:after:render": function() {
						...
						a.indexOf("safari") > -1 && -1 === a.indexOf("chrome") && this.triggerHostReflow()
					}
				},
				...
				getInstanceOrLoad: function(a) {
					var b = f.instance;
					return b ? b : (b = f.instance = new f(a), a.preload && b.listenToOnce(b, "afterInit", function() {
						b.frame.hide()
					}), b.init(), b)
				},
				preload: function(a) {
		...
		var b = a.document,
			...
			d = "//a.disquscdn.com/next/assets/img/loader-bg.aab79aac7146e054d372b00794ea3b14.png",
			e = DISQUS.next.host,
			f = e.utils,
			...
			h = g.extend({
				...
				events: {
					...
					"frame:bubble:init": function(b, c) {
						if (c.getOffset) {
							var d = "270px",
								...
								g = new DISQUS.Sandbox({
									uid: "notification-bubble",
							...
							g.click(function(a) {
								var b = i(a),
									d = b.getAttribute("data-action") || "click";
								c.sendMessage("bubble:" + d, this.uid.split("-")[1])
							}), this.on({
								"frame:bubble:show": function(b) {
					...
					"frame:change:sort": function(b) {
						a.localStorage && a.localStorage.setItem("disqus.sort", b)
					},
					...
					"loading.done": function() {
						this.triggeredSlowEvent && f.logStat("rendered_embed.slow")
					}
				},
				onceEvents: {
				...
				preloadHome: function(a) {
					a.path = "preload";
					var b = this.home = e.home.preload(this.getHomeData(a));
					this.listenToOnce(b, "frame:ready", function() {
						this.frame.sendMessage("home.ready")
					})
				},
				showHome: function(a) {
					var b = this.home = e.home.show(this.getHomeData(a));
		...
		return e.getContainer = function() {
			...
			return this.getValuesFromGlobals(), {
				container: e,
				forum: b.forum,
				sortOrder: b.experiment.sort_order || a.localStorage && a.localStorage.getItem("disqus.sort") || "default",
				language: b.language,
